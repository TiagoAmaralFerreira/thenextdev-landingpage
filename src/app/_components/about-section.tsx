        ...
        <div className='grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-y-12 lg:grid-rows-[auto-1fr]'>
          <div className='lg:pl-20 flex justify-center'>
            <div className='max-w-xs px-2.5 lg:max-w-none'>
              <Image src='/avatar.jpg' alt="Imagem" width={800} height={800} quality='95' priority={true} className="aspect-square rotate-3 rounded-lg bg-zinc-100 dark:bg-zinc-800 object-cover" />
            </div>
          </div>
        <div className='lg:order-first'>
          <h1 className='font-heading text-3xl md:text-4xl lg:row-span-2 text-center md:text-start'>@tiagoamaral</h1>
          ...
          <div className='mt-6 flex justify-center md:justify-start gap-6'>
            <SocialLink href='https://github.com/TiagoAmaralFerreira' icon={InstagramIcon} />
            <SocialLink href='https://github.com/TiagoAmaralFerreira' icon={GitHubIcon} />
            <SocialLink href='https://github.com/TiagoAmaralFerreira' icon={LinkedInIcon} />
            <SocialLink href='https://github.com/TiagoAmaralFerreira' icon={YoutTubeIcon} />
          </div>
        </div>
        </div>
      </section>
